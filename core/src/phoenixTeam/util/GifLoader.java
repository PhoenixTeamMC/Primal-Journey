...
public class GifLoader extends SynchronousAssetLoader<Animation, GifLoader.GifParameters>{
	...
	public GifLoader(FileHandleResolver r){
		super(r);
	}
	

	@Override
	public Animation load(AssetManager assetManager, String fileName, FileHandle file, GifParameters parameter) {
		this.read(file);
	...
	@Override
	public Array<AssetDescriptor> getDependencies(String fileName, FileHandle file, GifParameters parameter) {
		return null;
	}
    ...
    public int read(FileHandle file){
    ...
    public static class GifParameters extends AssetLoaderParameters<Animation>{
